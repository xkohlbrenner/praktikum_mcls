...
if __name__ == '__main__':
    ...
    #/* tissue parameters */
    BINS = 100      #/* number of bins, NZ and NR, for z and r */
    ...
    J       = np.zeros(NR+1)        #/* for escaping flux */
    F       = np.zeros([NZ+1, NR+1]) #/* for absorbed fluence rate */
    #/*************************/
    #/*************************/
    ...
    for iphoton in range(0, Nphotons): 
        ...
        if mcflag == 0:
            ...
            (rsp, uz) = RFresnel(n2, n1, costheta) #/* new uz */
